...
export const CarouselRomanceMovies = () => {
    ...
    const getRomanceMovies = async () => {
      try {
        const response = await axios.get(
          baseURL +
            '/discover/movie?include_adult=false&include_video=true&language=en-US&page=1&sort_by=vote_count.desc&with_genres=10749',
          {
            headers: {
